            	...
            	<form method="POST" action="{{ route('projects.store') }}">
                      {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            <label for="project-name" class="col-md-12 col-form-label text-md-left">Name</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                               <textarea id="project-content" name="description" spellcheck="false" class="form-control" rows="5">
